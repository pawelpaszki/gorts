...
```
./gorts baseline \
  --manifest ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/tests.json \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/baseline.json \
  --coverage-dir ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/coverage \
  --retry 1 \
...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/mapping.json
```
...
git checkout 646ef143df5de2cf81577812b108f15de80a1dbf
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/392429f6_646ef143/select_func.json
```
