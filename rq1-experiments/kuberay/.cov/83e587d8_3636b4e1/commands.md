...
```
./gorts baseline \
  --manifest ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/tests.json \
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/baseline.json \
  --coverage-dir ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/coverage \
  --retry 1 \
...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/mapping.json
```
...
./gorts select \
  --baseline ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/baseline.json \
  --mapping ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/83e587d8_3636b4e1/select_func.json
```
