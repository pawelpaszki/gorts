...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/88045fe2_c7a50c76/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/88045fe2_c7a50c76/mapping.json
```
...
git checkout c7a50c768e483c6675cb42b1f3a1e429468c6093
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/88045fe2_c7a50c76/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/88045fe2_c7a50c76/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/88045fe2_c7a50c76/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/88045fe2_c7a50c76/select_func.json
```
