...
```
./gorts baseline \
  --manifest ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/tests.json \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/baseline.json \
  --coverage-dir ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/coverage \
  --retry 1 \
...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/mapping.json
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/ea545e07_88045fe2/select_func.json
```
