...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/9488c555_506bea38/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/9488c555_506bea38/mapping.json
```
...
git checkout 506bea38e8a7a487773f725fc493e873147c3519
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/9488c555_506bea38/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/9488c555_506bea38/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/9488c555_506bea38/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/9488c555_506bea38/select_func.json
```
