...
```
./gorts baseline \
  --manifest ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/tests.json \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/baseline.json \
  --coverage-dir ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/coverage \
  --retry 1 \
...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/mapping.json
```
...
git checkout 3a3e634037813bebaa8e28d99041b284c2068e13
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/d41d70f3_3a3e6340/select_func.json
```
