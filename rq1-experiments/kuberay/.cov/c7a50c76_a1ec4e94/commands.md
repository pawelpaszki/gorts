...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/c7a50c76_a1ec4e94/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/c7a50c76_a1ec4e94/mapping.json
```
...
git checkout a1ec4e94172c06d0ac0fdeebbe6dc2b50d5713bb
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/c7a50c76_a1ec4e94/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/c7a50c76_a1ec4e94/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/c7a50c76_a1ec4e94/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/c7a50c76_a1ec4e94/select_func.json
```
