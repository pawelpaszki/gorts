...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/fea763aa_b30436ba/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/fea763aa_b30436ba/mapping.json
```
...
git checkout b30436bae34145abcdaa675c3202b6dd1d347873
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/fea763aa_b30436ba/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/fea763aa_b30436ba/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/fea763aa_b30436ba/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/fea763aa_b30436ba/select_func.json
```