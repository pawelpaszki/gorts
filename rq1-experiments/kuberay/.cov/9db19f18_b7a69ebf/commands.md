...
```
./gorts baseline \
  --manifest ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/tests.json \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/baseline.json \
  --coverage-dir ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/coverage \
  --retry 1 \
...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/mapping.json
```
...
git checkout b7a69ebf91c8e9d3f295f432afd205f270e0c07a
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/9db19f18_b7a69ebf/select_func.json
```
...
./gorts tests --directories ../../rhoai/upstream/kuberay/ray-operator/test/e2e,../../rhoai/upstream/kuberay/ray-operator/test/e2eautoscaler,../../rhoai/upstream/kuberay/ray-operator/test/e2eincrementalupgrade,../../rhoai/upstream/kuberay/ray-operator/test/e2erayjob,../../rhoai/upstream/kuberay/ray-operator/test/e2erayjobsubmitter,../../rhoai/upstream/kuberay/ray-operator/test/e2erayservice,../../rhoai/upstream/kuberay/ray-operator/test/e2eupgrade,../../rhoai/upstream/kuberay/ray-operator/test/sampleyaml --output ~/masters/gorts/rq1-experiments/kuberay/.cov/b7a69ebf_b80c782c/tests.json