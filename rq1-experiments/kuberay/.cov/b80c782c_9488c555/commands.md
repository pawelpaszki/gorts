...
```
./gorts baseline \
  --manifest ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/tests.json \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/baseline.json \
  --coverage-dir ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/coverage \
  --retry 1 \
...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/mapping.json
```
...
git checkout 9488c555bc2b8b36a2f2c6884ff9c365df93778b
```
...
./gorts select \
  --baseline ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/baseline.json \
  --mapping ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq1-experiments/kuberay/.cov/b80c782c_9488c555/select_func.json
```
