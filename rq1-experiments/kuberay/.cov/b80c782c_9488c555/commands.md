...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq2-experiments/kuberay/.cov/b80c782c_9488c555/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/b80c782c_9488c555/mapping.json
```
...
./gorts select \
  --baseline ~/masters/gorts/rq2-experiments/kuberay/.cov/b80c782c_9488c555/baseline.json \
  --mapping ~/masters/gorts/rq2-experiments/kuberay/.cov/b80c782c_9488c555/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/b80c782c_9488c555/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/b80c782c_9488c555/select_func.json
```
