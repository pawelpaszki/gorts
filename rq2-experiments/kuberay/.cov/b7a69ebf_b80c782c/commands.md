...
```
./gorts baseline \
  --manifest ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/tests.json \
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/baseline.json \
  --coverage-dir ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/coverage \
  --retry 1 \
...
```
./gorts mapping \
  --baseline ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/baseline.json \
  --module "github.com/ray-project/kuberay/ray-operator" \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/mapping.json
```
...
./gorts select \
  --baseline ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/baseline.json \
  --mapping ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/mapping.json \
  --repo ~/rhoai/upstream/kuberay/ray-operator \
  --strip-prefix ray-operator/ \
  --granularity file \
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/select_file.json
```
...
./gorts select \
  ...
  --output ~/masters/gorts/rq2-experiments/kuberay/.cov/b7a69ebf_b80c782c/select_func.json
```
